...
public class DemoComparator implements Comparator<DemoComparable> {
    ...
    //在实际使用时，一个集合不必自身实现该接口，而是让其内部类实现，这样可以实现解耦
    ...
    @Override
    public int compare(DemoComparable o1, DemoComparable o2) {
